...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PA6     ------> ADC1_IN6
    */
    GPIO_InitStruct.Pin = Voltage_Pin|T1_Pin|T2_Pin|Pressure_Pin
                          |Current_A_Pin|Current_B_Pin|Current_C_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA6     ------> ADC1_IN6
    */
    HAL_GPIO_DeInit(GPIOA, Voltage_Pin|T1_Pin|T2_Pin|Pressure_Pin
                          |Current_A_Pin|Current_B_Pin|Current_C_Pin);
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM4_MspInit 0 */
    ...
    PB6     ------> TIM4_CH1
    */
    GPIO_InitStruct.Pin = TIM4_Ch1_BTN_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(TIM4_Ch1_BTN_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PB6     ------> TIM4_CH1
    */
    HAL_GPIO_DeInit(TIM4_Ch1_BTN_GPIO_Port, TIM4_Ch1_BTN_Pin);
